...
- Pourquoi cela nous importe-t-il ? Les politiques programmatiques peuvent être plus équitables et favorables aux pauvres.
- Idée : les politiciens croient que les politiques clientélistes sont plus efficaces - et peut-être qu'ils changeraient leur stratégie de campagne s'ils savaient qu'ils ont tort.
...
- Conception expérimentale : Les circonsciptions sont assignées de manière aléatoire. 
:::
::::::
...
- Résultats : en moyenne, les électeurs préfèrent les campagnes clientélistes, mais les femmes sont plus susceptibles à préférer les politiques programmatiques.
...
Si les hommes politiques croient aux résultats $\rightarrow$ décident de changer leur stratégie de campagne
...
Malgré une introduction récente dans les sciences sociales, des impacts importants ont déjà été constatés \bigskip 

- A prouvé que des croyances de longue date étaient fausses.
...
## Proving beliefs wrong I \| Démontrer que les croyances sont fausses I
...
## Proving beliefs wrong II \| Démontrer que les croyances sont fausses II
...
## Proving beliefs wrong III \| Démontrer que les croyances sont fausses III
...
- Intervention: versement d'espèces aux mères à condition que les enfants aillent à l'école et se rendent dans les centres de santé
...
- Intervention: déparasiter tous les enfants d'une communauté en une seule fois
